...
import { secret, expiration } from '../src/env';
import bcrypt from 'bcrypt';
import jwt from 'jsonwebtoken';
import { validateLength, validatePassword } from '../src/validators';
...
const resolvers: Resolvers = {
  ...
  Query: {
    ...
    chats(root, args, { currentUser }) {
      ...
      return chats.filter(c => c.participants.includes('1'));
    },
  ...
  Mutation: {
    signIn(root, { username, password }: User, { res }) {
